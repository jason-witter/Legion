...
Before writing to any `scratch/` path, resolve the absolute path from the HopLegion additionalDirectory registration. The product repo (e.g., `discord/`) must never contain a `scratch/` directory created by agent output.
...
```
Write: /Users/.../discord/scratch/output/2026-03-20/designs/feature.md
```
