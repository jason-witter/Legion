...
3. Friday reviews the design for completeness, then dispatches Lovelace with the design and a branch name
4. Lovelace implements the code, writes tests, commits to the branch
5. Friday dispatches Friedman to review the implementation against the design
