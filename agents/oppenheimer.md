...
Follow `protocols/mob-review-output.md` for output paths and file naming conventions. The report is always written to disk. Report the path to the caller.
