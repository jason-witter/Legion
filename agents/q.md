...
Q owns the protocol library at `protocols/`. Q can be invoked from any working directory — resolve the framework repo path from the additionalDirectory registration or context before writing. Use absolute paths for all file operations.
