...
- `date` — `YYYY-MM-DD` of the current session.

## Steps

1. **Write the triage document** to `scratch/output/<date>/backlog-triage/assessment.md`. `scratch/` resolves to the framework repo per `rules/scratch-path-resolution.md`. See format below.
