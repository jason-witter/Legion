...
1. **Write the triage document** to `scratch/output/<date>/triage/backlog-assessment.md`. See format below.
...
- A single triage run produces one file. If a session produces multiple triage passes, use a distinguishing suffix: `backlog-assessment-2.md`.
