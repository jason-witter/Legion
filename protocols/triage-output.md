...
1. **Write the triage document** to `scratch/output/<date>/backlog-triage/assessment.md`. `scratch/` resolves to the Legion repo per `rules/scratch-path-resolution.md`. See format below.
