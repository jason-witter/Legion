...
2. **Write the design document** per `protocols/local/scratch-output-conventions.md` (e.g., `scratch/output/<date>/<task-slug>/design.md`). See format below. This is the handoff to the implementer.
