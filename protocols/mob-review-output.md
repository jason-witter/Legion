...
1. **Determine the feature directory** — `scratch/output/_<feature-slug>/`. `scratch/` resolves to the Legion repo per `rules/scratch-path-resolution.md`. If the directory does not exist, create it before writing.
