...
Agents that write output artifacts use a slug that includes the item identifier — for example, `pr-1234` where `1234` is the item identifier. This keeps artifacts identifiable and avoids collisions.
...
Item: [identifier — e.g., PR #1234 in owner/repo]
