...
`scratch/` resolves to the Legion repo per `rules/scratch-path-resolution.md`. The feature slug is provided by the pipeline context. Use `curie_<N>.md` where N is the next available number starting at 1 (e.g., `curie_1.md`, `curie_2.md`).
