...
Write the handoff to `scratch/output/_<feature-slug>/handoff.md`. `scratch/` resolves to the Legion repo per `rules/scratch-path-resolution.md`. Use `handoff_<N>.md` where N is the next available number starting at 1 (e.g., `handoff_1.md`, `handoff_2.md`). Report the path to the user.
