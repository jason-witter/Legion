...
2. **Write the ticket file** to `scratch/output/<date>/<task-slug>/tickets/<ticket-slug>.md` when produced within a task context. For standalone ticket writing (no parent task), use `scratch/output/<date>/<ticket-slug>/ticket.md`. See format below.
