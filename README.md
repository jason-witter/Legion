...
Every coding task runs through a four-station mob:
...
**Lovelace** (Implementer) writes production code from Babbage's design, matching the patterns already established in your codebase. She doesn't improve adjacent code or impose a preferred style — new code fits the repo it lives in.
